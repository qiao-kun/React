...
class Person extends Component {
    addPerson = () => {
        ...
        this.props.jiaYiRen(personObj)//同样是 映射createAddPersonAction
        this.nameNode.value = ''
        this.ageNode.value = ''
...
export default connect(
    state => ({ renState: state.rens, count: state.he })//映射状态(把#state.rens#仓库的状态值映射给renState给予页面使用)
